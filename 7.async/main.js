...
phoneAlarm.stop();
console.log("Идентификатор интервала: " + phoneAlarm.timerId); // после остановки снова равен null
phoneAlarm.clearAlarms();
phoneAlarm.printAlarms();   // распечатает 0 будильников